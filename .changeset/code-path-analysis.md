...
Both rules now work out the code paths through a catch block with the code path analysis of ESLint, instead of approximating them with a stack of block statements.
